// Illustrated equipment art — warm dark-soil thumbnails that match the
// hero panel aesthetic. Swap for real photography later (see README).

const palettes = {
  Tractor: { a: "#b98523", b: "#a8431f", sky: "#f3c96b" },
  Harvester: { a: "#a8431f", b: "#5e6e3e", sky: "#f3c96b" },
  Implement: { a: "#5e6e3e", b: "#4a3d2b", sky: "#c8d69c" },
};
    ...
    <svg viewBox="0 0 400 240" className={className} preserveAspectRatio="xMidYMid slice">
      <defs>
        <linearGradient id={`sky-${category}`} x1="0" y1="0" x2="0" y2="1">
          ...
          <stop offset="100%" stopColor="#201709" />
        </linearGradient>
      ...
      {/* ground */}
      <path d="M0 170 L400 170 L400 240 L0 240 Z" fill="#241a0e" />
      <path d="M0 170 Q200 150 400 172 L400 190 Q200 168 0 188 Z" fill="#2e2413" />
      {/* crop rows */}
      {Array.from({ length: 10 }).map((_, i) => (
        <line key={i} x1={i * 44} y1="240" x2={i * 44 - 30} y2="175" stroke="#4a3d2b" strokeWidth="2" />
      ))}

      {category === "Tractor" && (
        <g transform="translate(90,95)">
          <rect x="20" y="30" width="120" height="42" rx="6" fill={p.a} />
          <rect x="20" y="0" width="55" height="42" rx="6" fill="#241a0e" fillOpacity="0.9" />
      ...
      {category === "Harvester" && (
        <g transform="translate(60,70)">
          ...
          <rect x="70" y="5" width="60" height="45" rx="8" fill="#241a0e" fillOpacity="0.9" />
